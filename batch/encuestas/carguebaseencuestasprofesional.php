...
if(empty($archivoBase)){
    ...
    if(sizeof($erroresCarga)>0){
        ...
        $rutaErrores = "../../../archivos_nexuslink/encuestas/archivos_bases_encuestas_profesional/errores_carga/";
        $rutaFinErros = $rutaErrores.$nombreArchivo.".txt";

        $resl_vali = fopen("../../../archivos_nexuslink/encuestas/archivos_bases_encuestas_profesional/errores_carga/" . $nombreArchivo . ".txt", "w") or die("Problema al Crear Archivo"); // Archivo Escritura
