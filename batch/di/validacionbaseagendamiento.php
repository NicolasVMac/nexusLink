...
if(empty($archivoBase)){
    ...
    if(sizeof($errores)>0){
        ...
        $resl_vali = fopen("../../../archivos_nexuslink/di/agendamiento/archivos_bases_agendamiento/errores/" . $nombreFin . ".txt", "w") or die("Problema al Crear Archivo"); // Archivo Escritura
