...
class ModelContratistas
{
    ...
    static public function mdlActualizarValorContrato($idContrato, $valor){
        ...
        $stmt = Connection::connectOnly()->prepare("UPDATE contratistas_contratistas_contratos SET valor_contrato = :valor_contrato, cuantia_indeterminada = 'NO' WHERE id_contrato = :id_contrato");
