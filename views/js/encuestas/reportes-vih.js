    ...
    columns: [
        ...
        { name: 'ARCHIVO', render: function(data, type, row){
            ...
            if(row.estado == 'FINALIZADO'){
                ...
                return `<a class="badge badge-phoenix fs--2 badge-phoenix-success p-2" href="../../../archivos_vidamedical/encuestas/archivos_reportes_vih/${row.nombre_archivo}"><i class="far fa-file-excel"></i> ${row.nombre_archivo}</a>`;
