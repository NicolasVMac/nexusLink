    ...
    Swal.fire({
        ...
        if (result.isConfirmed){
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    'proceso': 'eliminarProfesionalModificacion',
                ...
                success:function(respuesta){
                    ...
                    if(respuesta == 'ok'){
                        ...
                        Swal.fire({
                            title: 'Error!',
                            text: '¡El Profesional no se puede eliminar correctamente!',
                            icon: 'error',
                            confirmButtonText: 'Cerrar',
                            allowOutsideClick: false,
                            allowEscapeKey: false,
                    ...
                    }else if(respuesta == 'error-eliminando-det-res'){

                        Swal.fire({
                            title: 'Error!',
                            text: '¡No se logro eliminar todo completamente, comuniquese con el administrador!',
                            icon: 'error',
                            confirmButtonText: 'Cerrar',
                            allowOutsideClick: false,
                            allowEscapeKey: false,
