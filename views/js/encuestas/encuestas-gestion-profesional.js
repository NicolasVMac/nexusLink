...
const terminarEncuesta = async () => {
    ...
    if(validacion == 'encuestas-pendientes'){
        ...
        Swal.fire({
            title: 'Error!',
            text: '¡La Encuesta no se puede terminar porque tiene Procesos pendiente por Gestionar!',
            icon: 'error',
            confirmButtonText: 'Cerrar',
            allowOutsideClick: false,
            allowEscapeKey: false,
        ...
        cadena += `<br>¿Desea terminar Auditoria Profesional?<br>`;
...
const guardarProcesoEncuesta = async (idEncuProceso, proceso) => {
    ...
    Swal.fire({
        title: "¿Desea Guardar la Auditoria Profesional?",
        icon: 'info',
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
        cancelButtonText: "Cancelar",
