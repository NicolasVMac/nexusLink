                    ...
                    if(respuesta == 'ok'){
                        ...
                        Swal.fire({
                            ...
                            if(result.isConfirmed){
                                ...
                                window.location = 'index.php?ruta=contratacion/listapagadores';
...
const irGestionContratos = (idPagador) => {
    ...
    window.location = 'index.php?ruta=contratacion/gestionarcontratospagador&idPagador='+btoa(idPagador);
}
