<div class="content">
    <h3 class="mb-3">Reporte Estado Proceso Pagadores</h3>
    <div class="row">
...
<script src="views/js/contratacion/reportes-pagadores.js?v=<?= md5_file('views/js/contratacion/reportes-pagadores.js') ?>"></script>