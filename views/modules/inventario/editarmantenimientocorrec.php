    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6">
            <div class="card shadow-none border border-300 mb-2" data-component-card="data-component-card">
                ...
                <div class="card-body">
                    <form id="formGestionEdicionMantenimiento" name="formGestionEdicionMantenimiento" role="form" method="post" enctype="multipart/form-data" onsubmit="return false;">
                        <div class="row mb-2">
                        ...
                        <center><button type="submit" class="btn btn-outline-success me-1" onclick="edicionMantenimiento()"><i class="far fa-save"></i> Guardar</button></center>
                    </form>
                </div>
            </div>
        </div>
