        ...
        <div class="card-header p-4 border-bottom border-300 bg-primary">
            <div class="row g-3 justify-content-between align-items-center">
                <div class="col-12 col-md">
                    <h4 class="text-white mb-0">Reporte Consolidado Infectologia VIH</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            <form id="formReportConsoInfectologo" name="formReportConsoInfectologo" role="form" method="post" enctype="multipart/form-data" onsubmit="return false;">
                <div class="row mb-2">
                ...
                <div class="row mb-2">
                    <center><button class="btn btn-success btn-sm" onclick="generarReportConsoInfectologoVIH()"><i class="fas fa-search"></i> Generar</button></center>
                </div>
            </form>
        </div>
    </div>

    <div class="card shadow-none border border-300 mb-2" id="cardResultadoReporteConsolidadoInfectologo" data-component-card="data-component-card" style="display: none;">
                            ...
                            <div class="table-responsive">
                                <table id="tablaDiligenciamiento" class="table table-striped" style="width:100%;">
                                    <thead>
                                        <tr>
                                            <th>ITEM</th>
                                            <th>% DE CUMPLIMIENTO DILIGENCIAMIENTO DE HISTORIA CLINICA MEDICOS ENCARGADOS DEL PROGRAMA DE VIH.</th>
                                        </tr>
                                    </thead>
