        ...
        <div class="card-header p-4 border-bottom border-300 bg-primary">
            <div class="row g-3 justify-content-between align-items-center">
                <div class="col-12 col-md">
                    <h4 class="text-white mb-0">Reporte Consolidado Datos Identificacion Autoinmunes</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            <form id="formReportConsoDatosIdentificacion" name="formReportConsoDatosIdentificacion" role="form" method="post" enctype="multipart/form-data" onsubmit="return false;">
                ...
                <div class="row mb-2">
                    <center><button class="btn btn-success btn-sm" onclick="generarReportConsoDatosIdentificacionAutoinmunes()"><i class="fas fa-search"></i> Generar</button></center>
                </div>
            </form>
        </div>
    </div>
