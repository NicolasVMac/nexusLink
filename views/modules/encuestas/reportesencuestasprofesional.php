<div class="content">
    <h3 class="mb-3">Reportes Encuestas Profesional</h3>
    <div class="row">
                ...
                <div class="card-header p-4 border-bottom border-300 bg-info">
                    <div class="row g-3 justify-content-between align-items-center">
                        <div class="col-12 col-md">
                            <h4 class="text-white mb-0">Reportes</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tablaReportesProfesional" class="table table-striped" style="width:100%;">
                            <thead>
                                <tr>
                                    <th>#</th>
