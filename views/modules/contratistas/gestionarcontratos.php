                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <span class="badge badge-phoenix badge-phoenix-secondary">Cuantia Indeterminada</span>
...
<script src="views/js/contratista/contratos.js?v=<?= md5_file('views/js/contratista/contratos.js') ?>"></script>