        ...
        <div class="card-header p-4 border-bottom border-300 bg-primary">
            <div class="row g-3 justify-content-between align-items-center">
                <div class="col-12 col-md">
                    <h4 class="text-white mb-0">Lista PQRSF Cargar Respuesta</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="tablaCargarResPQRS" class="table table-striped" style="width:100%;">
                    <thead>
                        <tr>
                            <th>#</th>
...
<!-- <div class="modal fade" id="modalCargarResPQR">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-grid gap-2">
                    <a class="btn btn-soft-info mt-2 me-2" data-bs-toggle="collapse" href="#collapseCargaResPQRSF" role="button" aria-expanded="false" aria-controls="collapseCargaResPQRSF"><i class="far fa-eye"></i> Informacion PQRSF</a>
                </div>
                <div class="collapse multi-collapse mb-3 mb-sm-0" id="collapseCargaResPQRSF">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-12 col-md-12">
                                    <label># PQRSF</label>
                                    <label class="form-control" id="txtIdPQRSRes"></label>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-12 col-md-4">
                                    <label>Nombre Paciente</label>
                                    <label class="form-control" id="txtNombrePacRes"></label>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <label>Tipo Identificacion Paciente</label>
                                    <label class="form-control" id="txtTipoDocPacRes"></label>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <label>Numero Identificacion Paciente</label>
                                    <label class="form-control" id="txtNumDocPacRes"></label>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-12 col-md-4">
                                    <label>Fecha Nacimiento</label>
                                    <label class="form-control" id="txtFechaNacPacRes"></label>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <label>EPS</label>
                                    <label class="form-control" id="txtEpsRes"></label>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <label>Regimen</label>
                                    <label class="form-control" id="txtRegimenEpsRes"></label>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-12 col-md-4">
                                    <label>Programa</label>
                                    <label class="form-control" id="txtProgramaRes"></label>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <label>Sede</label>
                                    <label class="form-control" id="txtSedeRes"></label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-12 col-md-4">
                                    ...
                                    <label class="form-control" id="txtNombrePetRes"></label>
                                </div>
                                <div class="col-sm-12 col-md-4">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <label class="form-control" id="txtObservaciones"></label>
                                </div>
                            </div>
                        </div>
                    </div>
