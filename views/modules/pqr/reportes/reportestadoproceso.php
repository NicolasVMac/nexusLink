        ...
        <div class="card-header p-4 border-bottom border-300 bg-success">
            <div class="row g-3 justify-content-between align-items-center">
                <div class="col-12 col-md">
                    <h4 class="text-white mb-0">Estado Proceso PQRSF</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div class="card shadow-lg border border-300 mb-2" data-component-card="data-component-card">
                <div class="card-body">
                    <form id="formRepEstadoProcesoPQRSF" name="formRepEstadoProcesoPQRSF" role="form" method="post" enctype="multipart/form-data" onsubmit="return false;">
                        <div class="row mb-3">
                        ...
                        <div class="row mb-2">
                            <center><button class="btn btn-success btn-sm" onclick="generarReporteEstadoProcesoPQRSF()"><i class="fas fa-search"></i> Generar</button></center>
                        </div>
                    </form>
                </div>
            </div>
            <div class="card shadow-lg border border-300 mb-2" id="cardResultEstadoProcesoPQRSF" data-component-card="data-component-card" style="display: none;">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-12 mb-2">
                            <div class="table-responsive">
                                <div class="mb-2">
                                    <span class="badge badge-phoenix badge-phoenix-danger">VENCIDAS</span><small> PQRSF menores o igual a 0 dias habiles para Respuesta.</small><br>
                                    <span class="badge badge-phoenix badge-phoenix-warning">A VENCER</span><small> PQRSF mayores a 0 y menores o iguales a 3 dias habiles para Respuesta.</small><br>
                                    <span class="badge badge-phoenix badge-phoenix-success">A TIEMPO</span><small> PQRSF mayores a 3 dias habiles para Respuesta.</small><br>
                                </div>
                                <table id="tablaEstadoProcesoPQRSF" class="table table-striped" style="width:100%;">
                                    <thead>
                                        <tr>
                                            <th>TIPO PQRSF</th>
                                            <th class="text-danger"><button class="btn btn-danger btn-sm" onclick="mostrarPqrsfEstadoProceso('VENCIDAS')"><i class="far fa-list-alt"></i></button> VENCIDAS</th>
                                            <th class="text-warning"><button class="btn btn-warning btn-sm" onclick="mostrarPqrsfEstadoProceso('A-VENCER')"><i class="far fa-list-alt"></i></button> A VENCER</th>
                                            <th class="text-success"><button class="btn btn-success btn-sm" onclick="mostrarPqrsfEstadoProceso('A-TIEMPO')"><i class="far fa-list-alt"></i></button> A TIEMPO</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-12 mb-2">
                            <div class="table-responsive">
                                <table id="tablePqrsfEstadoProceso" class="table table-striped" style="width:100%;">
                                    <thead>
                                        <tr>
                                            <th>#</th>
