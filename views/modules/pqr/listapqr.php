    ...
    <div class="card shadow-none border border-300 mb-2" data-component-card="data-component-card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <table id="tablaPQRS" class="table table-striped" style="width:100%;">
                    <thead>
                        <tr>
                            <th>#</th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-2">
                    <div class="col-sm-12 col-md-12">
                        <label>Tiempo Normativo</label>
                        <label class="form-control" id="txtTiempoNormativo"></label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <label>Horas Habiles Respuesta:</label>
                        <label class="form-control" id="txtHorasHabilesResp"></label>
                    </div>
                    <div class="col-md-6">
                        <label>Dias Habiles Respuesta:</label>
                        <label class="form-control" id="txtDiasHabilesResp"></label>
                    </div>
                </div>
                <hr>
                <div class="row mb-2">
