<div class="content">
    <h2 class="mb-3">Registrar PQRSF</h2>
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <form id="formCrearPqr" name="formCrearPqr" role="form" method="post" enctype="multipart/form-data" onsubmit="return false;">
                    ...
                    <div class="card-header p-4 border-bottom border-300 bg-primary">
                        <div class="row g-3 justify-content-between align-items-center">
                            ...
                            <div class="col col-md-auto">
                                <button class="btn btn-phoenix-primary ms-2" onclick="crearPQRS()"><i class="far fa-calendar-check"></i> Guardar PQRSF</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12 col-md-12">
                                ...
                                <textarea class="form-control editor" name="descripcionPqr" minlength="50" maxlength="100000"  placeholder="Descripcion de la PQRSF"></textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <input type="file" class="form-control" id="archivosPqr" name="archivosPqr" accept=".pdf" required multiple>
                            </div>
                        </div>
                    </div>
                </div>
