        ...
        <div class="card-header p-4 border-bottom border-300 bg-primary">
            <div class="row g-3 justify-content-between align-items-center">
                <div class="col-12 col-md">
                    <h4 class="text-white mb-0">PQRSF Gestionados Gestor: <?php echo $_SESSION["nombre"] ?> - <?php echo $_SESSION["usuario"]; ?></h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                ...
                <table id="tablaPQRSGestionadosGestor" class="table table-striped" style="width:100%;">
                    <thead>
                        <tr>
                            <th>#</th>
