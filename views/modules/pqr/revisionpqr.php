<div class="content">
    <h2 class="mb-3">Revision PQRSF</h2>
    <div class="row">
                        ...
                        <div class="row g-3 justify-content-between align-items-center">
                            ...
                            <div class="col col-md-auto">
                                <div class="nav nav-underline justify-content-end doc-tab-nav align-items-center">
                                    ...
                                    <button class="btn btn-phoenix-warning ms-2" onclick="actualizarPQRSF('SUPERVISOR')"><i class="far fa-edit"></i> Actualizar PQRSF</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-sm-12 col-md-6">
            <form id="formRevisionPqr" name="formRevisionPqr" role="form" method="post" enctype="multipart/form-data" onsubmit="return false;">
                <div class="card shadow-none border border-300 mb-2" data-component-card="data-component-card">
                    <div class="card-header p-4 border-bottom border-300 bg-success">
                        <div class="row g-3 justify-content-between align-items-center">
                            <div class="col-12 col-md">
                                <h4 class="text-white mb-0">Revision PQRSF</h4>
                            </div>
                            <div class="col col-md-auto">
                                <button class="btn btn-phoenix-success ms-2" onclick="terminarRevisionPQRS()"><i class="far fa-calendar-check"></i> Terminar Revision</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <label>¿Qué?</label>
                                <textarea class="form-control" rows="5" name="planAccionQue" id="planAccionQue" placeholder="¿Que se quiere mejorar?" minlength="50" maxlength="1000" required></textarea>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <label>¿Por Qué?</label>
                                <textarea class="form-control" rows="5" name="planAccionPorQue" id="planAccionPorQue" placeholder="¿Por que se quiere mejorar?" minlength="50" maxlength="2000" required></textarea>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-sm-12 col-md-6">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12 col-md-12">
                                <label>¿Como?</label>
                                <textarea class="form-control" rows="5" name="planAccionComo" id="planAccionComo" placeholder="¿Como lo va a mejorar?" minlength="50" maxlength="2000" required></textarea>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-sm-12 col-md-6">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12 col-md-6">
                                ...
                                <select class="form-select" name="planAccionPqrRecurrente" id="planAccionPqrRecurrente" style="width: 100%;" required disabled>
                                    <option value="">Seleccione</option>
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12 col-md-12">
                                ...
                                <textarea class="form-control" name="respuestaPQRSF" id="respuestaPQRSF" placeholder="Respuesta PQRSF" minlength="10" maxlength="100000"></textarea>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-sm-12 col-md-12">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12 col-md-12">
                                ...
                                <textarea class="form-control" rows="5" name="revisionObservaciones" id="revisionObservaciones" placeholder="Observaciones" minlength="10" maxlength="10000" required></textarea>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-sm-12 col-md-12">
                                <label>Adjuntar Archivos</label>
                                <input type="file" class="form-control" id="archivosPqr" name="archivosPqr" accept=".pdf" multiple>
                            </div>
                        </div>
                    </div>
                </div>
