    ...
    <div class="card shadow-none border border-300 mb-2" data-component-card="data-component-card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="tablaRevisionesPQRS" class="table table-striped" style="width:100%;">
                    <thead>
                        <tr>
                            <th>#</th>
...
<div class="modal fade" id="modalAsignarPQRS">
    <div class="modal-dialog modal-lg">
        <form id="formAsignarPQRS" name="formAsignarPQRS" role="form" method="post" enctype="multipart/form-data" onsubmit="return false;">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white" id="exampleModalLabel">Asignar PQRSF</h5>
                ...
                <div class="modal-body">
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-12">
                            <label>Gestor</label>
                            <select class="form-select" name="gestoresPqrAsignar" id="gestoresPqrAsignar" style="width: 100%;">
                            </select>
                            <input type="hidden" name="idPQRSAsignar" id="idPQRSAsignar">
                        </div>
                    </div>
                    <hr>
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-12">
                            <label># PQRSF</label>
                            <label class="form-control" id="txtIdPQRSAsignar"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-4">
                            <label>Nombre Paciente</label>
                            <label class="form-control" id="txtNombrePacAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Tipo Identificacion Paciente</label>
                            <label class="form-control" id="txtTipoDocPacAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Numero Identificacion Paciente</label>
                            <label class="form-control" id="txtNumDocPacAsignar"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-4">
                            <label>Fecha Nacimiento</label>
                            <label class="form-control" id="txtFechaNacPacAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>EPS</label>
                            <label class="form-control" id="txtEpsAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Regimen</label>
                            <label class="form-control" id="txtRegimenEpsAsignar"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-4">
                            <label>Programa</label>
                            <label class="form-control" id="txtProgramaAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Sede</label>
                            <label class="form-control" id="txtSedeAsignar"></label>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-4">
                            ...
                            <label class="form-control" id="txtNombrePetAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Tipo Identificacion Peticionario</label>
                            <label class="form-control" id="txtTipoDocPetAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Numero Identificacion Peticionario</label>
                            <label class="form-control" id="txtNumDocPetAsignar"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-4">
                            <label>Contacto Peticionario</label>
                            <label class="form-control" id="txtContactoPetAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Correo Peticionario</label>
                            <label class="form-control" id="txtCorreoPetAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Fecha PQRSF</label>
                            <label class="form-control" id="txtFechaPQRSFAsignar"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-4">
                            <label class="">Departamento</label>
                            <label class="form-control" id="txtDepPetAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label class="">Municipio</label>
                            <label class="form-control" id="txtMunPetAsignar"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-12">
                            <label>Descripcion PQRSF</label>
                            <label class="form-control" id="txtDescripcionPqrAsignar"></label>
                        </div>
                    </div>
                    <hr>
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-4">
                            ...
                            <label class="form-control" id="txtMedRecepPqrAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Fecha Apertura Buzon de Sugerencias</label>
                            <label class="form-control" id="txtFechaAperBuzonSugAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Fecha Hora Radicacion PQRSF</label>
                            <label class="form-control" id="txtFechaHoraRadPqrAsignar"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-4">
                            <label>Tipo PQRSF</label>
                            <label class="form-control" id="txtTipoPqrAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Ente Reporte PQRSF</label>
                            <label class="form-control" id="txtEnteRepPqrAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Motivo PQRSF</label>
                            <label class="form-control" id="txtMotivoPqrAsignar"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-4">
                            <label>Trabajador Relacionado PQRSF</label>
                            <label class="form-control" id="txtTrabajadorRelaPqrAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Servicio o Area Involucrado</label>
                            <label class="form-control" id="txtServAreaPqrAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Clasificacion Atributo</label>
                            <label class="form-control" id="txtCaliAtribuPqrAsignar"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-4">
                            <label>Gestor</label>
                            <label class="form-control" id="txtGestorPqrAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Tiempo Respuesta Normativo</label>
                            <label class="form-control" id="txtTiempoResNormaPqrAsignar"></label>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <label>Horas o Dias Oportunidad</label>
                            <label class="form-control" id="txtHorasDiasOportPqrAsignar"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-12 col-md-12">
                            <label>Archivos</label>
                            <div id="containerArchivosPQRSFAsignar"></div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-outline-danger" type="button" data-bs-dismiss="modal"><i class="fas fa-arrow-left"></i> Cerrar</button>
                    <button class="btn btn-success" onclick="asignarPQRS()" type="button"><i class="far fa-save"></i> Asignar</button>
                </div>
            </div>
        </form>
    </div>
