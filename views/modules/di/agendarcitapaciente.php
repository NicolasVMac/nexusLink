        ...
        <div class="card-header p-4 border-bottom border-300 bg-success">
            <div class="row g-3 justify-content-between align-items-center">
                ...
                <div class="col col-md-auto">
                    <button class="btn btn-phoenix-success ms-2" onclick="terminarAgendarCitaBuqueda()"><i class="fas fa-arrow-left"></i> Terminar</button>
                </div>
            </div>
        </div>
        <div class="card-body">
            <form id="formAgendarCitaBusqueda" name="formAgendarCitaBusqueda" role="form" method="post" enctype="multipart/form-data" onsubmit="return false;">
                <div class="row">
                        ...
                        <div class="card shadow-none border border-300 mb-2" data-component-card="data-component-card">
                            <div class="card-header p-4 border-bottom border-300 bg-primary">
                                <div class="row g-3 justify-content-between align-items-center">
                                    ...
                                    <div class="col col-md-auto">
                                        <button class="btn btn-phoenix-primary ms-2" onclick="crearCitaBusqueda()"><i class="far fa-save"></i> Agendar Cita</button>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-sm-12 col-md-12 mb-2">
                                        ...
                                        <select class="form-select select-field" name="cohortePrograma" id="cohortePrograma" required style="width: 100%;">
                                        </select>
                                        <input type="hidden" name="idPaciente" id="idPaciente" value="<?php echo base64_decode($_GET["idPaciente"]); ?>">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-12 col-md-12 mb-2">
